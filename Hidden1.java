...
//doget calls dopost
		   out.println("<form method=post "+ "action=Hidden1>");
		   out.println("<input type=hidden"+ " name=training value=Java>");
		   out.println("<input type=hidden "+ "name=Qualification value=BTech>");
...
PrintWriter out=response.getWriter();
	    ...
	    out.println("<h1>3rd Hidden: "+request.
	    		getParameter("training"));
out.println("  4th Hidden: "+request.
